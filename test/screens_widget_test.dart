...
void main() {
  ...
  testWidgets('HomeScreen renders greeting and 3 main action cards', (tester) async {
  ...
  testWidgets('JaapScreen renders dial, mantra, tap prompt, and increments on tap', (tester) async {
    configureViewport(tester);
  ...
  testWidgets('PanchangScreen renders Tithi, Sunrise, Sunset, and Dos/Donts', (tester) async {
    configureViewport(tester);
    await tester.pumpWidget(
      createTestApp(
    ...
    expect(find.text('शुक्ल पक्ष एकादशी'), findsOneWidget);
  ...
  testWidgets('AartiScreen renders Hanuman Chalisa, lyrics, and media controls', (tester) async {
    configureViewport(tester);
    await tester.pumpWidget(
      createTestApp(
        const AartiScreen(),
  ...
  testWidgets('MoreScreen renders God of the Day, Ganesha Mantra, and Pushpa Arpan', (tester) async {
    configureViewport(tester);
    await tester.pumpWidget(
      createTestApp(
        const MoreScreen(),
