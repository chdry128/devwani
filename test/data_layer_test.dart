...
void main() {
  group('Devavani Data Layer Tests', () {
    test('AppGods contains 6 canonical deities with complete tri-language data', () {
    ...
    test('AppAartis contains all 6 deity aartis with proper day/festival mapping', () {
    ...
    test('Backwards compatibility wrappers compile and provide legacy interface', () {
